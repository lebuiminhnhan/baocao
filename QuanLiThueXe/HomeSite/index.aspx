<%@ Page Title="" Language="C#" MasterPageFile="~/HomeSite/HomeSite.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="QuanLiThueXe.HomeSite.index" %>
				...
				<div class="col">
					<div class="new_arrivals_sorting">
						<ul class="arrivals_grid_sorting clearfix button-group filters-button-group">
							...
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".women">Xe tay ga</li>
							...
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".men">Xe côn tay</li>
						</ul>
					</div>
				</div>
			</div>
